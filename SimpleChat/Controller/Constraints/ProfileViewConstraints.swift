...
struct ProfileViewConstraints {
    static func makeConstraints(view: UIView, iconImageView: CustomImageView, signUpTitleLabel: TitleLabel, idLabel: CustomLabel, idText: CustomLabel, nameLabel: CustomLabel, nameText: CustomLabel, backButton: SelectButton){

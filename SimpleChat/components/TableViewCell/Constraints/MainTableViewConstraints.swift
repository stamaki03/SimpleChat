...
struct MainTableViewConstraints {
    static func makeConstraints(contentView: UIView, userIcon: CustomImageView, userName: CustomLabel, userLastMessage: CustomLabel, userLastMessageTime: CustomLabel){
        ...
        userLastMessage.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -10).isActive = true
        ...
        userLastMessageTime.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -10).isActive = true
